...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { codigo_articulo: @articulo.codigo_articulo, descripcion: @articulo.descripcion, suplidores: @articulo.suplidores, unidad_compra_diaria: @articulo.unidad_compra_diaria } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { codigo_articulo: @articulo.codigo_articulo, descripcion: @articulo.descripcion, suplidores: @articulo.suplidores, unidad_compra_diaria: @articulo.unidad_compra_diaria } }
